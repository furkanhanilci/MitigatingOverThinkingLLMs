# This is borrowed from https://github.com/hendrycks/apps/blob/main/eval/testing_util.py for coding evaluation with input/output runinng benchmarks like apps.
