...
def parse_model_answer(
    answer_text: str, expected_names: list
...
def compute_score(solution_str, ground_truth, results_cache, lock, format_reward=1):
    """Computes comprehensive score for model response.
    ...
    with lock:
        results_cache[(answer_text, json.dumps(ground_truth))] = total_score

    return total_score, answer_text
